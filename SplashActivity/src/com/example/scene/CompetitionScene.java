		...
		{	
			...
			public void run() 
			{
				...
				AlertDialog.Builder alert = new AlertDialog.Builder(ResourcesManager.getInstance().activity);
	             ...
	             Button b = (Button) ResourcesManager.getInstance().activity.findViewById(R.id.dialogButtonOK);
...
//			        public void run() {
//			         
//				//Toast.makeText(ResourcesManager.getInstance().activity, "You choose Level 1", Toast.LENGTH_SHORT).show();
//			      
//			        }
//				});
