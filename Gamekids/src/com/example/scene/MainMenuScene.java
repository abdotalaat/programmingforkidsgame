...
//		optionsMenuItem.setPosition(optionsMenuItem.getX()-20, optionsMenuItem.getY() - 110);
		...
		optionsMenuItem.setPosition((WIDTH/2 - optionsMenuItem.getWidth()/2)-50,(HEIGHT/2 - optionsMenuItem.getHeight()/2)-20);
		quitMenuItem.setPosition((WIDTH/2 - quitMenuItem.getWidth()/2)-50, (HEIGHT/2 - quitMenuItem.getHeight()/2)-220);
		competionsMenuItem.setPosition((WIDTH/2 - quitMenuItem.getWidth()/2)-50, (HEIGHT/2 - quitMenuItem.getHeight()/2)-120);
