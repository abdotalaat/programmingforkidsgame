...
public class XMLLayoutExample extends SimpleLayoutGameActivity {
	...
	{
		return R.id.xmllayoutexample_rendersurfaceview3;
	}
	...
	public EngineOptions onCreateEngineOptions() 
	{
		...
		return new EngineOptions(true, ScreenOrientation.PORTRAIT_FIXED, new RatioResolutionPolicy(XMLLayoutExample.CAMERA_WIDTH, XMLLayoutExample.CAMERA_HEIGHT), camera);
	}
